...
(function() {
  var New, Sprout, W, _, base_tpl_name, base_tpl_url, fs, global_config, inquirer, nodefn, npm, path;
  ...
  New = (function() {
    ...
    New.prototype.exec = function(opts) {
      var d, pkg, ref, ref1, ref2, sprout, sprout_opts;
      if (opts == null) {
        opts = {};
      }
      __track('api', {
