...
(function() {
  var New, Sprout, W, base_tpl_name, base_tpl_url, fs, global_config, inquirer, nodefn, npm, path, _;
  ...
  New = (function() {
    ...
    New.prototype.exec = function(opts) {
      var d, pkg, sprout, sprout_opts, _ref, _ref1, _ref2;
      if (opts == null) {
        opts = {};
      }
      __track('api', {
      ...
      sprout_opts = {
        ...
        questionnaire: function(questions, skip) {
          return W.promise(function(resolve, reject) {
            var qs, question, _i, _len;
            qs = [];
            ...
            return inquirer.prompt(qs, function(answers) {
              return resolve(answers);
            });
          });
        }
      };
      W.resolve(_.includes(_.keys(sprout.templates), base_tpl_name)).then(function(res) {
        if (!res) {
          return sprout.add(base_tpl_name, base_tpl_url).tap(function() {
            return d.notify('base template added');
          });
        }
      }).then(function() {
        return sprout.init(opts.name, opts.path, sprout_opts);
      }).tap(function() {
