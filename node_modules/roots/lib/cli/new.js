...
(function() {
  ...
  module.exports = function(cli, args) {
    ...
    return Roots["new"](args).progress(function(i) {
      ...
      cli.emit('info', "using template: " + ((_ref = args.template) != null ? _ref : 'roots-base'));
