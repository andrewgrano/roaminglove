...
{
buf.push("<img" + (jade.attr("src", "" + (imgixsrc) + "?w=257&h=185&fit=crop&crop=entropy&auto=compress,format", true, false)) + "/>");
}
else
{
buf.push("<img src=\"http://placehold.it/350x200?text=roaming+love\" class=\"img-responsive\"/>");
}
buf.push("</div><div class=\"postWidgetHorizontal__content\"><span class=\"postWidgetHorizontal__title\">" + (null == (jade_interp = post.title) ? "" : jade_interp) + "</span><span class=\"postWidgetHorizontal__author\">by " + (jade.escape((jade_interp = authorName) == null ? '' : jade_interp)) + "</span><ul class=\"postWidgetHorizontal__categories\">");
...
buf.push("</figure><div class=\"postWidget__content\"><div class=\"postWidget__main\"><div><span class=\"postWidget__title\">" + (null == (jade_interp = post.title) ? "" : jade_interp) + "</span><span class=\"postWidget__author\">by " + (jade.escape((jade_interp = authorName) == null ? '' : jade_interp)) + "</span></div></div><ul class=\"postWidget__categories\">");
// iterate post.categories
;(function(){
  var $$obj = post.categories;
  if ('number' == typeof $$obj.length) {
